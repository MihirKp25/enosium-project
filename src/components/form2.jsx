                ...
                <div className="grid grid-cols-1 md:grid-cols-2 ">
                    <div className="col-span-1  flex justify-center mt-10">
                        ...
                        <div className="grid grid-rows-4  p-5 rounded-xl bg-[#ffffff]">
                            ...
                            <div className="row-span-1 w-[400px]"><label className="font-semibold uppercase text-gray-500"> do you have telephone no. ?</label><select defaultChecked="" className="w-[100%]  py-3 bg-[#ffffff] border-b-2 px-1 border-[#ededed] outline-[#792ebe] hover:shadow-md hover:shadow-[#dbc4f1]" placeholder="Personal phone no." >
                            <option value="" disabled selected><span className="text-[#4e4c4c]">Choose from below options</span></option>
                            <option value="1">yes</option>
                            <option value="0">no</option>
                            </select>
                            </div>
                            <div className="row-span-1 w-[400px]"><label className="font-semibold uppercase text-gray-500">type of job you have done</label><select type="text" className="w-[100%]  py-3 bg-[#ffffff] border-b-2 px-1 border-[#ededed] outline-[#792ebe] hover:shadow-md hover:shadow-[#dbc4f1]" placeholder="Choose the type of job you have performed" >
                            <option value="" disabled selected><span className="text-[#4e4c4c]">Choose the type of job you have performed</span></option>
